...
// File: _coder_cartesian_trajectory_api.cpp
//
...
// Include Files
#include "_coder_cartesian_trajectory_api.h"
#include "_coder_cartesian_trajectory_mex.h"
...
emlrtContext emlrtContextGlobal{
    ...
    "cartesian_trajectory",                               // fFunctionName
                              ...
                              const mxArray *plhs[3])
{
  ...
  real_T ts;
  int32_T trajType_size[2];
  char_T trajType_data[10];
  ...
  emlrt_marshallIn(st, emlrtAliasP(prhs[3]), "trajType", trajType_data,
                   trajType_size);
  ...
  cartesian_trajectory(waypoints, waypointTimes, ts, trajType_data,
                       trajType_size, waypointVels, waypointAccels, xd, xd_vel,
                       xdd);
...
void cartesian_trajectory_atexit()
{
  ...
  cartesian_trajectory_xil_terminate();
  cartesian_trajectory_xil_shutdown();
...
//
// File trailer for _coder_cartesian_trajectory_api.cpp
//
// [EOF]
//
