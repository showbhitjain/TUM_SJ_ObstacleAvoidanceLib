...
Robot::createRobotMDH_from_Path(const std::string &configFile_Path, const std::string &parameterFor,
    ...
    Config = Config_file.getSubConfig(
...
Robot::Robot(const std::string &configFile_Path, const std::string &parameterFor, const std::string &whichrobot,
        ...
        createRobotMDH_from_Path(configFile_Path, parameterFor, whichrobot, baseFrame)) {
    auto Config_file = ConfigurationParameters(configFile_Path,
                                               parameterFor); //get the file which has path to the robotconfigfile
...
Eigen::MatrixXd Robot::jacobianCartesianOnLink(const VectorXd &jointValues, const int &toIthLink,
                                               const VectorXd &distanceRelativeToIthLink) const {
