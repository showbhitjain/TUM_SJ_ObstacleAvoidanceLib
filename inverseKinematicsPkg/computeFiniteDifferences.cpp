                                   ...
                                   const array<double, 1U> &ub)
{
  ...
  while ((!exitg1) && (idx <= obj.nVar - 1)) {
    ...
    ubDiff = inverseKinematics_anonFcn1(
        obj.objfun.workspace.jacobi, obj.objfun.workspace.xd_eff_vel.data,
        obj.objfun.workspace.xd_eff_vel.size[0],
        obj.objfun.workspace.starting_joint_vel,
        obj.objfun.workspace.joint_values,
        obj.objfun.workspace.config.useObjective1,
        obj.objfun.workspace.config.weight1,
        obj.objfun.workspace.config.useObjective2,
        obj.objfun.workspace.config.weight2,
        obj.objfun.workspace.config.useObjective3,
        obj.objfun.workspace.config.weight3,
        obj.objfun.workspace.config.useObjective4,
        obj.objfun.workspace.config.weight4,
        obj.objfun.workspace.config.useObjective5,
        obj.objfun.workspace.config.weight5,
        obj.objfun.workspace.config.useObjective6,
        obj.objfun.workspace.config.weight6, xk);
