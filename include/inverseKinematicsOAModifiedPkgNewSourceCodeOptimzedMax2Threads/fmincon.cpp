...
#pragma omp parallel for num_threads(                                          \
  ...
  if (*exitflag == -2.0) {
    ...
    if (static_cast<int>(mLinIneq < 200)) {
      for (int b_k{0}; b_k < mLinIneq; b_k++) {
        fscales_lineq_constraint[b_k] = 1.0;
      }
    } else {
#pragma omp parallel for num_threads(                                          \
    4 > omp_get_max_threads() ? omp_get_max_threads() : 4)
    ...
    WorkingSet.sizesNormal[0] = mFixed;
    WorkingSet.sizesNormal[1] = mLinEq;
    nVar = (mFixed + mLinEq) + 1;
    WorkingSet.sizesNormal[2] = mLinIneq;
    WorkingSet.isActiveIdxRegPhaseOne[3] = nVar + mLinIneq;
    WorkingSet.sizesNormal[3] = maxDims;
    WorkingSet.isActiveIdxRegPhaseOne[4] =
        WorkingSet.isActiveIdxRegPhaseOne[3] + maxDims;
    WorkingSet.sizesNormal[4] = mUB;
    WorkingSet.isActiveIdxRegPhaseOne[5] =
        WorkingSet.isActiveIdxRegPhaseOne[4] + mUB;
    WorkingSet.isActiveIdx[0] = 1;
    WorkingSet.isActiveIdxNormal[0] = 1;
    WorkingSet.isActiveIdx[1] = mFixed + 1;
    WorkingSet.isActiveIdxNormal[1] = mFixed + 1;
    WorkingSet.isActiveIdx[2] = nVar;
    WorkingSet.isActiveIdxNormal[2] = nVar;
    ...
    WorkingSet.isActiveIdxRegPhaseOne[3] = nVar + mLinIneq;
    WorkingSet.isActiveIdxRegPhaseOne[4] =
        (WorkingSet.isActiveIdxRegPhaseOne[3] + maxDims) + 1;
    WorkingSet.isActiveIdxRegPhaseOne[5] =
        WorkingSet.isActiveIdxRegPhaseOne[4] + mUB;
    WorkingSet.isActiveIdxPhaseOne[0] = 1;
    WorkingSet.isActiveIdxPhaseOne[1] = mFixed + 1;
    WorkingSet.isActiveIdxPhaseOne[2] = nVar;
    ...
    WorkingSet.isActiveIdxRegPhaseOne[3] = nVar + mLinIneq;
    WorkingSet.isActiveIdxRegPhaseOne[4] =
        WorkingSet.isActiveIdxRegPhaseOne[3] + i;
    WorkingSet.isActiveIdxRegPhaseOne[5] =
        WorkingSet.isActiveIdxRegPhaseOne[4] + mUB;
    WorkingSet.isActiveIdxRegularized[0] = 1;
    WorkingSet.isActiveIdxRegularized[1] = mFixed + 1;
    WorkingSet.isActiveIdxRegularized[2] = nVar;
    WorkingSet.isActiveIdxRegularized[3] = WorkingSet.isActiveIdxRegPhaseOne[3];
    WorkingSet.isActiveIdxRegularized[4] = WorkingSet.isActiveIdxRegPhaseOne[4];
    WorkingSet.isActiveIdxRegularized[5] = WorkingSet.isActiveIdxRegPhaseOne[5];
    WorkingSet.isActiveIdxRegPhaseOne[0] = 1;
    WorkingSet.isActiveIdxRegPhaseOne[1] = mFixed + 1;
    WorkingSet.isActiveIdxRegPhaseOne[2] = nVar;
    WorkingSet.isActiveIdxRegPhaseOne[3] = nVar + mLinIneq;
    WorkingSet.isActiveIdxRegPhaseOne[4] =
        (WorkingSet.isActiveIdxRegPhaseOne[3] + i) + 1;
    WorkingSet.isActiveIdxRegPhaseOne[5] =
        WorkingSet.isActiveIdxRegPhaseOne[4] + mUB;
    if (mLinIneq > 0) {
      i = WorkingSet.nVar;
