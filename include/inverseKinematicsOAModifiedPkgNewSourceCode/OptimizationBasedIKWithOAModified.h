...
public:
    ...
    void inverseKinematicsOAModified(
        ...
        coder::array<double, 1U> &optimal_joint_velocity, double constraintTolerance, int maxIterations,
        double optimalityTolerance, double stepTolerance, double *Exit_Flag);
